...
def kl_divergence_from_logits(logits_a, logits_b):
    ...
    """
    distribution1 = tf.distributions.Categorical(logits=logits_a)
    distribution2 = tf.distributions.Categorical(logits=logits_b)
    return tf.distributions.kl_divergence(distribution1, distribution2)
